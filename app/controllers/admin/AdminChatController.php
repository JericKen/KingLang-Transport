...
class AdminChatController {
    ...
    public function assignConversation() {
        try {
            ...
            // Assign admin to conversation
            $success = $this->chatModel->assignAdminToConversation($conversationId, $_SESSION['user_id']);
    ...
    public function sendMessage() {
        try {
            ...
            if (!$conversation || $conversation['admin_id'] != $_SESSION['user_id']) {
            ...
            // Add admin message
            $messageId = $this->chatModel->addMessage($conversationId, 'admin', $_SESSION['user_id'], $message);
