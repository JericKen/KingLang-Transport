...
CREATE TABLE `canceled_trips` (
  ...
  `cancellation_reason_category` varchar(100) DEFAULT NULL,
  ...
  KEY `idx_cancellation_reason_category` (`cancellation_reason_category`)
...
) ENGINE=InnoDB AUTO_INCREMENT=2609863 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-06  6:58:15
